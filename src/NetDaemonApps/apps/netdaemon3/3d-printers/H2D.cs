...
public class PrinterApp
{
  ...
  private readonly ILogger<PrinterApp> _logger;

  /// <summary>
  /// Initializes a new instance of the <see cref="PrinterApp"/> class.
  ...
  public PrinterApp(Entities entities, Services services, ITriggerManager triggerManager, ITextToSpeechService tts, IScheduler scheduler, ILogger<PrinterApp> logger)
  {
    _entities = entities;
